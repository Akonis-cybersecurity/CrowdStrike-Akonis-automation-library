...
class CrowdstrikeFalconClient(ApiClient):
    ...
    def get_alerts_v2(self, composite_ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
            "/alerts/entities/alerts/v2",
            json={"composite_ids": composite_ids},
    ...
    def get_ioc_actions(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "GET",
    ...
    def get_indicators_report(self, report_format: str = "csv", search: dict | None = None, **kwargs) -> Generator[dict, None, None]:
        body: dict[str, Any] = {"report_format": report_format}
        if search:
            body["search"] = search
        yield from self.request_endpoint(
            "POST",
            "/iocs/entities/indicators-report/v1",
            json=body,
            **kwargs,
        )

    def get_indicators(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "GET",
            "/iocs/entities/indicators/v1",
            params={"ids": ids},
    ...
    def create_indicators(self, indicators: list[dict], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
            "/iocs/entities/indicators/v1",
            json={"indicators": indicators},
    ...
    def update_indicators(self, indicators: list[dict], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "PATCH",
            "/iocs/entities/indicators/v1",
            json={"indicators": indicators},
    ...
    def search_indicators(self, filter: str | None = None, sort: str | None = None, limit: int | None = None, offset: str | None = None, **kwargs) -> Generator[dict, None, None]:
        params: dict[str, Any] = {}
        if filter:
    ...
    def get_behaviors(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
    ...
    def get_incidents(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
    ...
    def query_devices_by_filter(self, filter: str | None = None, sort: str | None = None, limit: int | None = None, offset: str | None = None, **kwargs) -> Generator[str, None, None]:
        params: dict[str, Any] = {}
        if filter:
            params["filter"] = filter
        if sort:
    ...
    def query_device_login_history(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
            "/devices/entities/devices/login-history/v2",
            json={"ids": ids},
            **kwargs,
        )

    def get_online_state(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "GET",
    ...
    def perform_prevention_policy_action(self, action_name: str, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
    ...
    def get_prevention_policies(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "GET",
    ...
    def create_prevention_policies(self, resources: list[dict], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "POST",
            "/policy/entities/prevention/v1",
    ...
    def delete_prevention_policies(self, ids: list[str], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "DELETE",
            "/policy/entities/prevention/v1",
            params={"ids": ids},
    ...
    def update_prevention_policies(self, resources: list[dict], **kwargs) -> Generator[dict, None, None]:
        yield from self.request_endpoint(
            "PATCH",
            "/policy/entities/prevention/v1",
            json={"resources": resources},
